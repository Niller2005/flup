...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.9ed4774c.js", "_app/immutable/chunks/index.2784db99.js", "_app/immutable/chunks/stores.afae4f20.js", "_app/immutable/chunks/singletons.83512bab.js"];
    stylesheets = ["_app/immutable/assets/0.51fd44ed.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.4461e4cc.js", "_app/immutable/chunks/index.2784db99.js", "_app/immutable/chunks/stores.afae4f20.js", "_app/immutable/chunks/singletons.83512bab.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.7198a1a2.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
<div class="flex flex-col gap-2"><main class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 mt-5 gap-4">${each(predictions, (prediction) => {
        return `${prediction.status === "succeeded" && prediction.source === "api" && prediction.input?.max_train_steps !== 2e3 ? `<a${add_attribute("href", `/imagegen/${prediction.id}`, 0)} class="card bg-neutral shadow-xl text-neutral-content">${prediction.output.length === 1 ? `<img${add_attribute("src", `/_vercel/image?url=${encodeURIComponent(prediction.output[0])}&w=500&q=75`, 0)} alt="AI Generated"${add_classes((nsfwWords.some((nw) => getInput(prediction.input)?.toLowerCase().includes(nw)) ? "blur-2xl" : "").trim())}>` : `<figure class="${[
          "flex flex-wrap",
          ...
          return `
								<img${add_attribute("src", `/_vercel/image?url=${encodeURIComponent(output)}&w=150&q=75`, 0)} class="w-1/2" alt="AI Generated">`;
        })}
						</figure>`}
					<div class="card-body">
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.223fe0da.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    imports5 = ["_app/immutable/nodes/4.fb8b39b1.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kick/_channel_/_page.ts.js
var page_ts_exports = {};
__export(page_ts_exports, {
  load: () => load3
});
var getChannelInfo, load3;
...
// .svelte-kit/output/server/entries/pages/kick/_channel_/_page.svelte.js
...
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/kick/_channel_/_page.svelte.js"() {
    ...
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      parsedData = data.channelInfo.charAt(0) === "{" ? JSON.parse(data.channelInfo) : data.channelInfo;
      return `<main class="flex gap-4 items-center justify-center h-full"><div class="avatar"><div class="w-24 rounded"><img${add_attribute("src", parsedData.user?.profile_pic, 0)}${add_attribute("alt", `${parsedData.user?.username} profile picture`, 0)}></div></div>
	<div class="flex flex-col"><span class="text-3xl">${escape(parsedData.user?.username)}</span>
		${parsedData.livestream ? `<span class="text-success">LIVE</span>
			<div class="flex gap-4"><a${add_attribute("href", `https://kick.com/${parsedData.slug}`, 0)} class="link">Kick</a>
				<a${add_attribute("href", `${parsedData.playback_url}`, 0)} class="link">Direct link (For VLC/MPV)</a></div>
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    universal_id = "src/routes/kick/[channel]/+page.ts";
    imports6 = ["_app/immutable/nodes/5.9649d00d.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    imports7 = ["_app/immutable/nodes/6.aa17107a.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets7 = [];
    fonts7 = [];
  }
});
...
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    ...
    imports8 = ["_app/immutable/nodes/7.f24173e4.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets8 = [];
    fonts8 = [];
  }
});
...
var init__9 = __esm({
  ".svelte-kit/output/server/nodes/8.js"() {
    ...
    imports9 = ["_app/immutable/nodes/8.b0751f50.js", "_app/immutable/chunks/index.2784db99.js"];
    stylesheets9 = [];
    fonts9 = [];
  }
});
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { "start": "_app/immutable/entry/start.fb69cdb7.js", "app": "_app/immutable/entry/app.1187b28f.js", "imports": ["_app/immutable/entry/start.fb69cdb7.js", "_app/immutable/chunks/index.2784db99.js", "_app/immutable/chunks/singletons.83512bab.js", "_app/immutable/entry/app.1187b28f.js", "_app/immutable/chunks/index.2784db99.js"], "stylesheets": [], "fonts": [] },
      nodes: [
